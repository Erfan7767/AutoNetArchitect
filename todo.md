...
- [x] Reject non-lab or production targets without a written human laboratory authorization and matching approved scope.
- [x] Enforce the written laboratory authorization precondition in the executable validation workflow and cover it with tests.
