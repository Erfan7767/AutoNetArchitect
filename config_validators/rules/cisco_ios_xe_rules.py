...
KNOWN_COMMANDS = {
    ...
    "rule_21": CommandRule(r"^ip\\s+access-list\\s+(?:standard|extended)\\s+\\S+$", valid_modes=('global',), description='Named ACL'),
    "rule_22": CommandRule(r"^crypto\\s+ikev2\\s+.*$", valid_modes=('global',), description='IKEv2'),
}
FORBIDDEN_PATTERNS = []
