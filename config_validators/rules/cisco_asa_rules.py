...
KNOWN_COMMANDS = {
    ...
    "rule_21": CommandRule(r"^(?:nameif|security-level|ip\\s+address|route|access-group|object|object-group|nat|crypto|tunnel-group|failover)\\s+.*$", valid_modes=('global',), description='ASA feature'),
}
FORBIDDEN_PATTERNS = []
