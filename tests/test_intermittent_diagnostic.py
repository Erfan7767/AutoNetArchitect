from troubleshooting.diagnostic_workflows import IntermittentDiagnostic
from troubleshooting.models import EvidenceCollection, EvidenceItem, CollectionMethod, EvidenceSource


def test_intermittent_diagnostic_is_read_only_and_produces_output():
    workflow = IntermittentDiagnostic()
