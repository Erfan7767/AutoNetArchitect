...
Validator = getattr(import_module("config_validators.vendor_validators.cisco_ios_xe_validator"), "CiscoIosXeValidator")


def test_cisco_ios_xe_valid_fixture_has_no_invalid_lines():
...
def test_cisco_ios_xe_invalid_fixture_is_detected():
