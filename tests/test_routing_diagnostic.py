from troubleshooting.diagnostic_workflows import RoutingDiagnostic
from troubleshooting.models import EvidenceCollection, EvidenceItem, CollectionMethod, EvidenceSource


def test_routing_diagnostic_is_read_only_and_produces_output():
    workflow = RoutingDiagnostic()
