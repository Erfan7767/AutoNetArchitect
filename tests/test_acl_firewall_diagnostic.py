from troubleshooting.diagnostic_workflows import ACLFirewallDiagnostic
from troubleshooting.models import EvidenceCollection, EvidenceItem, CollectionMethod, EvidenceSource


def test_acl_firewall_diagnostic_is_read_only_and_produces_output():
    workflow = ACLFirewallDiagnostic()
