from troubleshooting.diagnostic_workflows import PerformanceDiagnostic
from troubleshooting.models import EvidenceCollection, EvidenceItem, CollectionMethod, EvidenceSource


def test_performance_diagnostic_is_read_only_and_produces_output():
    workflow = PerformanceDiagnostic()
