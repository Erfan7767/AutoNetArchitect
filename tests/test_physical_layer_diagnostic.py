from troubleshooting.diagnostic_workflows import PhysicalLayerDiagnostic
from troubleshooting.models import EvidenceCollection, EvidenceItem, CollectionMethod, EvidenceSource


def test_physical_layer_diagnostic_is_read_only_and_produces_output():
    workflow = PhysicalLayerDiagnostic()
