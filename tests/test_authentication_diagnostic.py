from troubleshooting.diagnostic_workflows import AuthenticationDiagnostic
from troubleshooting.models import EvidenceCollection, EvidenceItem, CollectionMethod, EvidenceSource


def test_authentication_diagnostic_is_read_only_and_produces_output():
    workflow = AuthenticationDiagnostic()
