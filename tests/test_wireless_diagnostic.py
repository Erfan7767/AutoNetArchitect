from troubleshooting.diagnostic_workflows import WirelessDiagnostic
from troubleshooting.models import EvidenceCollection, EvidenceItem, CollectionMethod, EvidenceSource


def test_wireless_diagnostic_is_read_only_and_produces_output():
    workflow = WirelessDiagnostic()
